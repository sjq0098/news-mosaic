    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 opacity-30">
          {/* 浮动的马卡龙色彩圆形 */}
          <div className="absolute top-20 left-16 w-40 h-40 bg-macaron-mint/20 rounded-full blur-xl animate-gentle-pulse"></div>
          <div className="absolute top-40 right-24 w-32 h-32 bg-macaron-lavender/20 rounded-full blur-lg animate-bounce"></div>
          <div className="absolute bottom-32 left-32 w-48 h-48 bg-macaron-yellow/20 rounded-full blur-2xl animate-gentle-pulse"></div>
          <div className="absolute bottom-20 right-20 w-36 h-36 bg-macaron-pink/20 rounded-full blur-lg animate-bounce"></div>
      ...
      <div className="relative z-10 w-full absolute top-0 left-0 right-0">
        <div className="flex justify-center items-center w-full pt-12 pb-8">
          <div className="text-center">
            {/* 品牌图标 - 马卡龙风格 */}
            <div className="inline-flex items-center justify-center w-28 h-28 bg-gradient-to-br from-macaron-mint to-primary-300 rounded-3xl mb-12 shadow-xl animate-gentle-float backdrop-blur-sm border border-white/20">
              <BarChartOutlined className="text-gray-700 text-5xl" />
            </div>
          ...
          <Col xs={0} lg={13} className="px-20 pb-20">
            <div className="max-w-2xl mx-auto">
              ...
              <div className="space-y-8 mb-16">
                ...
                <div className="feature-card macaron-hover">
                  <div className="flex items-start space-x-6">
                    <div className="feature-icon-wrapper bg-macaron-yellow">
              ...
              <div className="testimonial-card mb-12">
                ...
                <p className="font-caption text-body-lg text-gray-500">— 来自新用户的真实反馈</p>
              </div>
              ...
              >
                <div className="px-12 py-12">
                  ...
                  <div className="text-center mb-8">
                    <Title level={2} className="font-heading text-heading-lg text-gray-800 mb-4">
                      创建新账户
                    </Title>
                    <Text className="font-body text-body-md text-gray-600">
                      加入我们，开始您的智能新闻分析之旅
                    </Text>
                  </div>
                  ...
                  >
                    <Row gutter={12}>
                      <Col span={12}>
                        <Form.Item
                          label={<span className="font-caption text-body-sm text-gray-700">用户名</span>}
                          name="username"
                          className="mb-6"
                          rules={[
                        ...
                        >
                          <Input
                            ...
                            placeholder="用户名"
                            className="auth-input font-body h-10"
                          />
                        </Form.Item>
                      </Col>
                      <Col span={12}>
                        <Form.Item
                          label={<span className="font-caption text-body-sm text-gray-700">昵称（可选）</span>}
                          name="nickname"
                          className="mb-6"
                          rules={[
                    ...
                    <Form.Item
                      label={<span className="font-caption text-body-sm text-gray-700">邮箱地址</span>}
                      name="email"
                      className="mb-6"
                      rules={[
                    ...
                    <Form.Item
                      label={<span className="font-caption text-body-sm text-gray-700">密码</span>}
                      name="password"
                      className="mb-4"
                      rules={[
                      ...
                      {passwordStrength > 0 && (
                        <div className="mt-2">
                          <div className="flex justify-between items-center mb-1">
                            <Text className="font-caption text-body-xs text-gray-600">密码强度</Text>
                            <Text className={`font-caption text-body-xs ${
                              passwordStrength < 30 ? 'text-red-400' :
                              passwordStrength < 60 ? 'text-orange-400' :
                              passwordStrength < 90 ? 'text-primary-500' : 'text-green-500'
                            }`}>
                          ...
                          <Progress
                            ...
                            showInfo={false}
                            strokeColor={
                              passwordStrength < 30 ? '#FCA5A5' :
                              passwordStrength < 60 ? '#FDE68A' :
                              passwordStrength < 90 ? '#A8D8F0' : '#86EFAC'
                            }
                            size="small"
                    ...
                    <Form.Item
                      label={<span className="font-caption text-body-sm text-gray-700">确认密码</span>}
                    ...
                    <Form.Item className="mb-6">
                      <Button
                        ...
                        className="auth-button w-full bg-gradient-to-r from-macaron-mint to-primary-300 border-0 text-gray-800 font-subheading hover:from-primary-300 hover:to-primary-400 macaron-button"
                      >
                  ...
                  {/* 服务条款 - 优化样式 */}
                  <div className="text-center font-body text-body-xs text-gray-500 mb-4">
                    注册即表示您同意我们的
                    <Button type="link" className="p-0 mx-1 text-primary-600 text-body-xs font-caption">服务条款</Button>
                    和
                    <Button type="link" className="p-0 mx-1 text-primary-600 text-body-xs font-caption">隐私政策</Button>
                  </div>

                  {/* 登录链接 - 优化样式 */}
                  <div className="text-center">
                    <Text className="font-body text-body-md text-gray-600">已有账号？</Text>
                    <Button
                      type="link"
